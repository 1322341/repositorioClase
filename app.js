...
// Reemplaza los guiones por la constante para que utilice ese numero de puerto// Sabes por que lo definimos como constante y no como variable ?
...
app.get('/creditos', (req, res) => {
  res.send('Mi nombre es Alejandro Placio: No importa cómo caes, sino cómo te levantas.')
})
